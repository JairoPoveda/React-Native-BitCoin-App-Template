                ...
                <ImageBackground source={require('./images/background.png')} style={{width:this.stateDim.width, height:this.stateDim.height,}}>
                    <View style={styles.nav_Bar}>
                        ...
                        <View style={styles.nav_touchImage2}>
                            <Text style={{fontSize:18, color:'white'}}>Add btccoin alert</Text>
                        </View>
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate('App9')} style={styles.nav_touchImage3}>
                            <Image
                                style={styles.iconStyle}
                    ...
                    <View style={styles.buySellButton}>
                        ...
                        <TouchableOpacity
                            ...
                            //onPress={()=>this.props.navigation.navigate('SettingScreen')}
                        >
                            <Text style={styles.buttonText}>REPEATING</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{marginLeft:'5%', backgroundColor:'#404041', width:'90%', height:'8%', marginTop:'10%', flexDirection:'row'}}>
                        <TextInput
                        ...
                        <TouchableOpacity style={{flexDirection:'row',backgroundColor:'grey',width:'30%',alignItems:'center',justifyContent:'center'}}>
                            ...
                            <Image source={require('./images/nextpageIcon.png')} style={{left:'15%', width:17, height:30}}>
                            </Image>
                        </TouchableOpacity>
                    </View>
                    ...
                    <TouchableOpacity style={{ height:'8%',
                        ...
                        <View style={{ width:'85%',
                            ...
                            <Text style={{fontSize:18, color:'white', }}>ADD ALERT</Text>
                        </View>
                    </TouchableOpacity>
