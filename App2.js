            ...
            <View style={styles.MainContainer}>
                <ImageBackground source={require('./images/background.png')} style={{width:this.state.width,height:this.state.height}}>
                    ...
                    <View style={styles.contentContainer}>
                        <Text style={{fontSize:20, color:'black',left:'10%',}}>General</Text>

                        <TouchableOpacity style={styles.button} activeOpacity={0.5}>
                            <View style={styles.textContainer}>
                                <Text style={{fontSize:10, color:'white'}}>Default Currency</Text>
                                <Text style={{fontSize:15, color:'white'}}>US Dollar(USD)</Text>
                            </View>
                            <Image style={styles.icon} source={require('./images/nextpageIcon.png')} />
                        </TouchableOpacity>
                        <Button_kind name="Nodification Options"/>
                        <Button_kind name="Other Options"/>
                    </View>
                    <View style={styles.contentContainer}>
                        <Text style={{fontSize:20, color:'black',left:'10%',}}>Data Recovery</Text>

                        <Button_kind name="Become App Pro(Early Backer Deal)" />
                        <Button_kind name="Early Access" />
                        <Button_kind name="Restore Purchases" />
                    </View>
                    <View style={styles.contentContainer_modify}>
                        ...
                        <TouchableOpacity style={styles.button_modify} activeOpacity={0.5}>
                            <Text style={styles.TextStyle}>Become App Pro(Early Backer Deal)</Text>
                            <Image style={styles.icon} source={require('./images/nextpageIcon.png')}  />
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.button_modify} activeOpacity={0.5}>
                            <Text style={styles.TextStyle}>Early Access</Text>
                            <Image style={styles.icon} source={require('./images/nextpageIcon.png')}  />
                        </TouchableOpacity>
                    </View>
                    <View style={styles.navBar}>
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate('App3')} style={styles.nav_touchImage1}>
                            <Image
